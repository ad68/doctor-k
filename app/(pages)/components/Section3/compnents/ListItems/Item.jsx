  ...
  return (
    <>
      <section className="flex flex-col h-[185px] w-[203px] items-center border border-solid border-[#EFEFEF] rounded-[15px]">
        <Image src={img} width={80} height={80} className="mt-[-47px]"/>
        <section className="flex flex-col text-sm justify-center items-center mt-[37px] gap-2">
        <span>{name}</span>
        <span className="flex gap-[10px] items-center"> <Image src='/images/icons/VectorStar.svg' width={17.11} height={16.36} className=""/> {rate}</span>
